...
const ProfileCard = () => {
  ...
  return (
    <SectionLayout>
      <Text type="h2" text="Tracing The Root" weight={600} styles={{ fontSize: "2.5rem",textAlign: "center", margin: ".5rem auto 3.5rem", fontFamily: "Whyte Inktrap",}}/>
      <Content>
        <Image
          src={Left}
        ...
        />
        <Text type="p" color="#222" size={18} text="
